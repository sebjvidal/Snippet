...
class SNWindowSettingsOpacityTableCellView: NSTableRowView, SNSettingsTableCellView {
    ...
    private func _setupSlider() {
        ...
        _opacitySlider.doubleValue = CacheManager.shared.opacity
        _opacitySlider.action = #selector(_opacitySliderValueChanged)
    ...
    @objc private func _opacitySliderValueChanged() {
        CacheManager.shared.setOpacity(to: _opacitySlider.doubleValue)
        CanvasManager.shared.setOpacity(to: _opacitySlider.doubleValue)
    }
