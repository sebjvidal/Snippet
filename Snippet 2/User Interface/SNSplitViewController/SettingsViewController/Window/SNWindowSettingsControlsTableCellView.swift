...
class SNWindowSettingsControlsTableCellView: NSTableRowView, SNSettingsTableCellView {
    ...
    private func _setupButtons() {
        ...
        _colourfulButton.selectionGroup = "Controls"
        _colourfulButton.isSelected = CacheManager.shared.controlStyle == .colourful
        _colourfulButton.action = {
            CanvasManager.shared.setControlStyle(to: .colourful)
            CacheManager.shared.setControlStyle(to: .colourful)
        }
        ...
        _graphiteButton.selectionGroup = "Controls"
        _graphiteButton.isSelected = CacheManager.shared.controlStyle == .graphite
        _graphiteButton.action = {
            CanvasManager.shared.setControlStyle(to: .graphite)
            CacheManager.shared.setControlStyle(to: .graphite)
        }
        ...
        _noneButton.selectionGroup = "Controls"
        _noneButton.isSelected = CacheManager.shared.controlStyle == .none
        _noneButton.action = {
            CanvasManager.shared.setControlStyle(to: .none)
            CacheManager.shared.setControlStyle(to: .none)
        }
